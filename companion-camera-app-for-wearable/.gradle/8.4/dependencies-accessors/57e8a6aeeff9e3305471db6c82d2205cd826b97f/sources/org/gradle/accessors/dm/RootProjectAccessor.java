...
public class RootProjectAccessor extends TypeSafeProjectDependencyFactory {
     ...
     */
    public CompanionCameraAppForWearableProjectDependency getCompanionCameraAppForWearable() { return new CompanionCameraAppForWearableProjectDependency(getFactory(), create(":")); }
