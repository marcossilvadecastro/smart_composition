...
@NonNullApi
public class CompanionCameraAppForWearableProjectDependency extends DelegatingProjectDependency {

    @Inject
    public CompanionCameraAppForWearableProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
